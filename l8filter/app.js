...
function sortingzam1(){
	...
	for(var a=0; a < getli.length; a++){
		lis.push(getli[a].textContent);
	}
...
function sortingazm2(){
	...
	do{
		...
		if(shouldswitch){
			...
			// element.insertBefore(new,existing) (or) node..insertBefore(new,existing) must be parent element or node
